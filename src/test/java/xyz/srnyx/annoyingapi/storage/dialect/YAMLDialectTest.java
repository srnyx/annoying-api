...
/**
 * Tests for {@link xyz.srnyx.annoyingapi.storage.dialects.YAMLDialect} (no database involved, plain file I/O)
 */
class YAMLDialectTest extends StorageTestSupport {

    @NotNull
    private Dialect createYamlDialect() throws ConnectionException {
        return createDataManager(StorageMethod.YAML).dialect;
    }

    @Test
    void setAndGet_roundTrips() throws ConnectionException {
        final Dialect dialect = createYamlDialect();
